package com.codeazur.as3swf.events
{
	...
	public class SWFParsingEvent extends Event
	{
		...
		public function SWFParsingEvent(type:String, data:SWFData, bubbles:Boolean=false, cancelable:Boolean=false)
		{
		...
		override public function clone():Event {
			return new SWFParsingEvent(type, data, bubbles, cancelable);
		}
